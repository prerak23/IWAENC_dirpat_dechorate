...
abcd=h5py.File(path_root+"D5_1111/noisy_mixtures/D5_1111_aggregated_mixture.hdf5",'r') #Open the noisy mixture file
anno_file=h5py.File(path_root+"D5_1111/noisy_mixtures/D5_1111_aggregated_mixture_annotations.hdf5",'r')
