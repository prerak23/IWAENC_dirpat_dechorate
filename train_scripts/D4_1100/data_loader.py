...
abcd=h5py.File(path_root+"D4_1100/noisy_mixtures/D4_1100_aggregated_mixture.hdf5",'r') #Open the noisy mixture file
anno_file=h5py.File(path_root+"D4_1100/noisy_mixtures/D4_1100_aggregated_mixture_annotations.hdf5",'r')
