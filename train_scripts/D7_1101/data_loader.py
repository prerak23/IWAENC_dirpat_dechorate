...
abcd=h5py.File(path_root+"D7_1101/noisy_mixtures/D7_1101_aggregated_mixture.hdf5",'r') #Open the noisy mixture file
anno_file=h5py.File(path_root+"D7_1101/noisy_mixtures/D7_1101_aggregated_mixture_annotations.hdf5",'r')
