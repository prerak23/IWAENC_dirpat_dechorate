...
abcd=h5py.File(path_root+"D3_1010/noisy_mixtures/D3_1010_aggregated_mixture.hdf5",'r') #Open the noisy mixture file
anno_file=h5py.File(path_root+"D3_1010/noisy_mixtures/D3_1010_aggregated_mixture_annotations.hdf5",'r')
