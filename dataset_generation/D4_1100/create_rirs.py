...
file_name_rirs="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/D4_1100/generated_rirs_D4_1100_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
file_name_anno_rirs="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/D4_1100/D4_1100_anno_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
...
with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D4_1100/conf_room_setup_D4_1100.yml') as f:
    room_setup = yaml.load(f, Loader=SafeLoader)


with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D4_1100/conf_receivers_D4_1100.yml') as f_1:
    receiver_rooms = yaml.load(f_1, Loader=SafeLoader)


with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D4_1100/conf_source_D4_1100.yml') as f_2:
    source_rooms = yaml.load(f_2, Loader=SafeLoader)

with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D4_1100/conf_noise_source_D4_1100.yml') as f_3:
...
for room_no in tqdm(divided_rooms[parallel_batch_no]):
    ...
    if src_directivity == "CARDIOID":
        dir_obj_1 = CardioidFamily(
        orientation=DirectionVector(azimuth=source_rooms[room_id]["source_ypr"][0][0],colatitude=source_rooms[room_id]["source_ypr"][0][1], degrees=True),
        pattern_enum=DirectivityPattern.CARDIOID,
        )
        room.add_source(source_rooms[room_id]["source_pos"][0],directivity=dir_obj_1)
    elif src_directivity == "SUBCARDIOID" :
        dir_obj_1 = CardioidFamily(
        orientation=DirectionVector(azimuth=source_rooms[room_id]["source_ypr"][0][0],colatitude=source_rooms[room_id]["source_ypr"][0][1], degrees=True),
        pattern_enum=DirectivityPattern.SUBCARDIOID,
        )
        room.add_source(source_rooms[room_id]["source_pos"][0],directivity=dir_obj_1)
    elif src_directivity == "HYPERCARDIOID" :
        dir_obj_1 = CardioidFamily(
        orientation=DirectionVector(azimuth=source_rooms[room_id]["source_ypr"][0][0],colatitude=source_rooms[room_id]["source_ypr"][0][1], degrees=True),
