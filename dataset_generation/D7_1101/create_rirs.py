...
file_name_rirs="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/D7_1101/generated_rirs_D7_1101_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
file_name_anno_rirs="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/D7_1101/D7_1101_anno_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
...
with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D7_1101/conf_room_setup_D7_1101.yml') as f:
    room_setup = yaml.load(f, Loader=SafeLoader)


with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D7_1101/conf_receivers_D7_1101.yml') as f_1:
    receiver_rooms = yaml.load(f_1, Loader=SafeLoader)


with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D7_1101/conf_source_D7_1101.yml') as f_2:
    source_rooms = yaml.load(f_2, Loader=SafeLoader)

with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D7_1101/conf_noise_source_D7_1101.yml') as f_3:
