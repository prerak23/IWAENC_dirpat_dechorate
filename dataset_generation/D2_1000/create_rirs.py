...
file_name_rirs="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/D2_1000/generated_rirs_D2_1000_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
file_name_anno_rirs="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/D2_1000/D2_1000_anno_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
...
with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D2_1000/conf_room_setup_D2_1000.yml') as f:
    room_setup = yaml.load(f, Loader=SafeLoader)


with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D2_1000/conf_receivers_D2_1000.yml') as f_1:
    receiver_rooms = yaml.load(f_1, Loader=SafeLoader)


with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D2_1000/conf_source_D2_1000.yml') as f_2:
    source_rooms = yaml.load(f_2, Loader=SafeLoader)

with open('/home/psrivastava/axis-2/IWAENC/dataset_generation/D2_1000/conf_noise_source_D2_1000.yml') as f_3:
