...
std_rt60=[ 0.284315, 0.306951, 0.278283, 0.238538, 0.219537, 0.193914] #For 125,250,500,1000,2000,4000 Hz
...
net_1 = Model_1().to(torch.device("cpu"))
#net_2 = Model_2().to(torch.device("cuda"))
net_3 = Model_3().to(torch.device("cpu"))

net = Ensemble(net_1, net_3,16).to(torch.device("cpu"))
...
#path="/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/training/D5_1111/"
