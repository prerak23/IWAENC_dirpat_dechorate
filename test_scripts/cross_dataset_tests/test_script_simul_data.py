...
chkp=torch.load("/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/training/D2_1000/mlh_tas_save_best_sh.pt",map_location=device)
...
np.save("/home/psrivastava/axis-2/IWAENC/z_test/cross_dataset_tests/D5_D2.npy",estimate)
