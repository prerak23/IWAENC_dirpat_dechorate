#!/bin/sh
#OAR -l core=2,walltime=5:00:00
#OAR -p gpu_count='0'
#OAR --array-param-file /home/psrivastava/axis-2/IWAENC/z_test/jobs_test.txt
#OAR -O /home/psrivastava/logs_oarsub/D5/oar_job.%jobid%.output
#OAR -E /home/psrivastava/logs_oarsub/D5/oar_job.%jobid%.error
set -xv

/home/psrivastava/axis-2/IWAENC/z_test/D5_test_set/run_cmd.sh $*
