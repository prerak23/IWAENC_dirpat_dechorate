...
file_name_rirs="generated_rirs_D4_1100_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
file_name_anno_rirs="D4_1100_anno_rooms_"+str(divided_rooms[parallel_batch_no][0])+"_"+str(divided_rooms[parallel_batch_no][-1])+".hdf5"
...
with open('/home/psrivastava/axis-2/IWAENC/z_test/D4_test_set/conf_room_setup_D4_1100_2.yml') as f:
    room_setup = yaml.load(f, Loader=SafeLoader)


with open('/home/psrivastava/axis-2/IWAENC/z_test/D4_test_set/conf_receivers_D4_1100_2.yml') as f_1:
    receiver_rooms = yaml.load(f_1, Loader=SafeLoader)


with open('/home/psrivastava/axis-2/IWAENC/z_test/D4_test_set/conf_source_D4_1100_2.yml') as f_2:
    source_rooms = yaml.load(f_2, Loader=SafeLoader)

with open('/home/psrivastava/axis-2/IWAENC/z_test/D4_test_set/conf_noise_source_D4_1100_2.yml') as f_3:
