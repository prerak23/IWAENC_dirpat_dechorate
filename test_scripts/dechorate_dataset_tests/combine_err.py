...
D7_chkp_1=np.load(root_path+"D7_test_set"+"/D7_real_data_000000.npy")
D7_chkp_2=np.load(root_path+"D7_test_set"+"/D7_real_data_000001.npy")
D7_chkp_3=np.load(root_path+"D7_test_set"+"/D7_real_data_000010.npy")
D7_chkp_4=np.load(root_path+"D7_test_set"+"/D7_real_data_000100.npy")
D7_chkp_5=np.load(root_path+"D7_test_set"+"/D7_real_data_010000.npy")
...
D7_chkp_10=np.load(root_path+"D7_test_set"+"/D7_real_data_020002.npy")
...
D7_rooms=[D7_chkp_1,D7_chkp_2,D7_chkp_3,D7_chkp_4,D7_chkp_5,D7_chkp_6,D7_chkp_7,D7_chkp_8,D7_chkp_9,D7_chkp_10]
...
for i in np.arange(10):
        ...
        D7_err_=np.concatenate((D7_surf,D7_vol,D7_rt60_500,D7_rt60_1000,D7_rt60_2000,D7_rt60_4000),axis=1)
        ...
        D6_err_=np.concatenate((D6_surf,D6_vol,D6_rt60_500,D6_rt60_1000,D6_rt60_2000,D6_rt60_4000),axis=1)
        ...
        D5_err_=np.concatenate((D5_surf,D5_vol,D5_rt60_500,D5_rt60_1000,D5_rt60_2000,D5_rt60_4000),axis=1)
        ...
        D4_err_=np.concatenate((D4_surf,D4_vol,D4_rt60_500,D4_rt60_1000,D4_rt60_2000,D4_rt60_4000),axis=1)
        ...
        D3_err_=np.concatenate((D3_surf,D3_vol,D3_rt60_500,D3_rt60_1000,D3_rt60_2000,D3_rt60_4000),axis=1)
        ...
        D2_err_=np.concatenate((D2_surf,D2_vol,D2_rt60_500,D2_rt60_1000,D2_rt60_2000,D2_rt60_4000),axis=1)
        ...
        D1_err_=np.concatenate((D1_surf,D1_vol,D1_rt60_500,D1_rt60_1000,D1_rt60_2000,D1_rt60_4000),axis=1)
...
plt.savefig("real_decorate_all_err_vp3_2.png")
