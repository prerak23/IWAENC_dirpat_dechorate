...
#OAR -O /home/psrivastava/logs_oarsub/D3/oar_job.%jobid%.output
#OAR -E /home/psrivastava/logs_oarsub/D3/oar_job.%jobid%.error
set -xv

/home/psrivastava/axis-2/IWAENC/z_test/D3_test_set/run_cmd.sh $*
