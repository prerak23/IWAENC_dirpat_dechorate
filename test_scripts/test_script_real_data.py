...
chkp=torch.load("/srv/storage/talc3@talc-data.nancy/multispeech/calcul/users/psrivast/IWAENC/training/D1_0000/mlh_tas_save_best_sh.pt",map_location=device)
...
mic=[(1,5),(6,10),(11,15)] #,(16,20),(21,25)]
#src=[3]
src=[0,1,2,3,4,5]
...
for r in [files_]:
    ...
    for s in src:
        ...
        #for mic in itr:
        combined_ch_1=room_wet_speech[48000:96000,mic[0][0]:mic[0][1]:3,s]  #mic[0],mic[1]  #32000,80000
...
np.save("/home/psrivastava/axis-2/IWAENC/z_test/D1_test_set/D1_real_data_"+room_no+".npy",total_pred)
